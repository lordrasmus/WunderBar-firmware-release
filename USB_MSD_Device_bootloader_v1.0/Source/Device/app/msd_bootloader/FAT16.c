...
const uint_8 FAT16_BootSector[FATBootSize]= 
{
    ...
    0,              /*30 - BPB_HiddSec = 0 */
    0,              /*31 - BPB_HiddSec = 0 */
    0x00,           /*32 - BPB_TotSec32 = 1,983,495 */
    0xB4,           /*33 - BPB_TotSec32 = 1,983,495 */
        ...
        case FATRootDirSec0:
            ...
            switch (BootloaderStatus) 
            {
                ...
                default:
                    ...
                    break;
                case BootloaderS19Error:
                    *pu8DataPointer++ = 'S';
                    *pu8DataPointer++ = 'F';
                    *pu8DataPointer++ = GetASCIIValue((uint_8)((S19Address >> 20) & 0xF));
                    *pu8DataPointer++ = GetASCIIValue((uint_8)((S19Address >> 16) & 0xF));
                    *pu8DataPointer++ = GetASCIIValue((uint_8)((S19Address >> 12) & 0xF));
                    *pu8DataPointer++ = GetASCIIValue((uint_8)((S19Address >>  8) & 0xF));
                    *pu8DataPointer++ = GetASCIIValue((uint_8)((S19Address >>  4) & 0xF));
                    *pu8DataPointer++ = GetASCIIValue((uint_8)((S19Address >>  0) & 0xF));
                    *pu8DataPointer++ = 'T';
                    *pu8DataPointer++ = 'X';
                    *pu8DataPointer++ = 'T';
                    break;
