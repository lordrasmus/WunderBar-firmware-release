...
#define FATSecPerClust   32
#define FATBootSec        0
#define FATTable0Sec0     4
#define FATTable1Sec0   250
#define FATRootDirSec0  496
#define FATDataSec0     528

#define FILEFreeDataSec0   FATDataSec0    // first available cluster (#2)
...
void FATReadLBA(uint_32 FAT_LBA,uint_8_ptr pu8DataPointer,uint_32 pu8Len);
