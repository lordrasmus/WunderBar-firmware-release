...
**     Date/Time   : 2014-05-12, 11:34, # CodeGen: 8
**     Abstract    :
...
#define BitsIoLdd1_MODULE_BASE_ADDRESS PTA_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORTCONTROL_BASE_ADDRESS PORTA_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORT_MASK 0x20000000U /*!< Mask of the allocated pin from the port */
...
#define BitsIoLdd1_PIN_ALLOC_0_MASK 0x20000000 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_INDEX 29U /*!< The index of the first allocated pin from the port */
