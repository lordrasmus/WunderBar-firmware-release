...
#define BOOTLOADER_BUTTON_PIN           22		                                                  /**< Button used to enter SW update mode. */
#define BOOTLOADER_LED_PIN              29																											/**< Diagnostic LED. */
...
{   gpio_set_pin_digital_input(BOOTLOADER_BUTTON_PIN, PIN_PULL_UP);
...
int main(void)
{
    ...
    bootloader_is_pushed = ((gpio_read(BOOTLOADER_BUTTON_PIN) == 0)? true: false);
