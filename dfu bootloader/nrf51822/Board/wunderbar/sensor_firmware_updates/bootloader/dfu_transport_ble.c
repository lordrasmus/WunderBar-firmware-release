...
#ifdef __DFU_HTU__
#define DEVICE_NAME                          "DfuHTU"                                                /**< Name of device. Will be included in the advertising data. */
#elif __DFU_MICROPHONE__
#define DEVICE_NAME                          "DfuMIC"                                                /**< Name of device. Will be included in the advertising data. */
#elif __DFU_LIGHT_PROXIMITY__
#define DEVICE_NAME                          "DfuLIGHT"                                              /**< Name of device. Will be included in the advertising data. */
#elif __DFU_BRIDGE__
#define DEVICE_NAME                          "DfuBRIDG"                                              /**< Name of device. Will be included in the advertising data. */
#elif __DFU_IR__
#define DEVICE_NAME                          "DfuIR"                                                 /**< Name of device. Will be included in the advertising data. */
#elif __DFU_ACCEL_GYRO__
#define DEVICE_NAME                          "DfuGYRO"                                               /**< Name of device. Will be included in the advertising data. */
#else
